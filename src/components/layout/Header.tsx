...
export function Header() {
  ...
  // NOTE : plus de spacer ici. Le header est en fixed overlay translucide ; chaque hero de page
  // doit avoir un padding-top suffisant (>= 6rem) pour que son contenu ne soit pas cache. Cela
  // permet au fond du hero (paper-surface, photo, etc.) de couvrir la zone sous le header sans
  // bande blanche intermediaire.
  return (
