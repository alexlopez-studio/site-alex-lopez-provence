...
export const metadata: Metadata = {
  title: 'Accès direct espace vendeur',
  robots: { index: false, follow: false },
}

export default async function ClientPortalDirectPreviewPage({ params, searchParams }: PageProps) {
  ...
  if (process.env.NODE_ENV === 'production') {
    ...
    if (!admin) redirect(`/admin/login?redirect=/espace-client/preview/${id}`)
  }
