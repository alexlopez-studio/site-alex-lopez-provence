...
export function MarketShell({
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset className="app-product min-w-0 bg-background">
        <header className="flex h-12 shrink-0 items-center gap-2 border-b bg-card/90 px-4 backdrop-blur lg:px-6">
