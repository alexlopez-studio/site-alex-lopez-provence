...
export const metadata: Metadata = {
  title: 'Recherche acheteur | Alex Lopez \u00b7 Mandataire IAD',
  description: 'D\u00e9finissez votre projet achat immobilier en Provence Verte. Alex Lopez vous accompagne dans votre recherche.',
}
    ...
    <div style={pageSt}>
      ...
      <main style={mainSt}>
        <div style={cardSt}>
          ...
          <h1 style={h1St}>Votre projet acheteur</h1>
          <p style={subSt}>Le formulaire de recherche acheteur sera disponible prochainement. En attendant, contactez-moi directement pour me parler de votre projet.</p>
