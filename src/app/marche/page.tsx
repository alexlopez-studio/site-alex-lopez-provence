...
export const metadata: Metadata = {
  title: 'Zone d’intervention — Provence Verte & Haut-Var',
  description: 'Alexandre Lopez accompagne vos projets immobiliers en Provence Verte, Haut-Var et dans les communes voisines.',
  ...
  return (
    <main className="bg-white px-6 py-20">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <h1 className="mb-5 text-3xl font-extrabold tracking-[-0.03em] text-foreground md:text-5xl">Provence Verte & Haut-Var</h1>
        <p className="mx-auto mb-10 max-w-2xl text-muted leading-relaxed">J’interviens sur l’ensemble de la Provence Verte et du Haut-Var pour accompagner vos projets de vente, d’achat ou d’estimation immobilière.</p>
