...
export const LOCAL_PAGES: Record<string, LocalPage> = {
  barjols: {
    ...
    description: 'Vous vendez une maison à Barjols ? Repères de marché, critères de prix et avis de valeur local avec Alexandre Lopez, conseiller immobilier en Provence Verte et Haut-Var.',
    ...
    marketBullets: [
      'Commune de Provence Verte et du Haut-Var avec un marché plus accessible que certains villages très recherchés du Var intérieur.',
  ...
  tavernes: {
    slug: 'tavernes',
    name: 'Tavernes',
    title: 'Immobilier à Tavernes : prix, marché et estimation de maison',
    description: 'Vous vendez une maison à Tavernes ? Repères de marché DVF, caractéristiques de village, environnement Provence Verte et avis de valeur local avec Alexandre Lopez iad.',
    intro: 'À Tavernes, le marché immobilier est typique de la Provence Verte rurale : maisons de village en pierre, villas avec jardin dans les écarts et propriétés au calme. L’estimation doit tenir compte de la configuration du village, de l’accessibilité, du terrain et des travaux de rénovation.',
    priceSummary: 'Les données DVF et les portails publics situent les maisons de Tavernes entre 2 400 et 3 000 €/m² en moyenne. Les écarts sont marqués entre une maison de village sans extérieur et une maison individuelle bénéficiant d’une parcelle arborée et d’une vue dégagée.',
    marketBullets: [
      'Village préservé de Provence Verte, apprécié pour sa quiétude et sa proximité immédiate avec Barjols et Varages.',
      'Demande active pour les maisons de plain-pied et les résidences secondaires au vert.',
      'Impact fort de l’assainissement (collectif vs autonome) et de la conformité des installations.',
      'Marché de volume modéré : chaque vente comparable récente influence directement la perception du prix.',
    ],
    propertyTypes: [
      'Maisons de village traditionnelles avec dépendances ou caves voutées.',
      'Villas et pavillons contemporains avec jardin et vue colline.',
      'Propriétés rurales ou anciennes bâtisses à rénover avec grand terrain.',
      'Pied-à-terre de vacances et résidences secondaires.',
    ],
    estimationFactors: [
      'Situation : cœur de village ou quartier périphérique calme',
      'Surface habitable réelle et agencement des pièces',
      'Extérieur : jardin, terrasse, vue et exposition',
      'Performance énergétique (DPE) et système de chauffage',
      'Stationnement privatif et facilité de manœuvre',
      'Historique des ventes DVF récentes sur Tavernes et Barjols',
    ],
    nearbyLinks: [
      { href: '/immobilier/barjols', label: 'Barjols' },
      { href: '/immobilier/ponteves', label: 'Pontevès' },
    ...
    faq: [
      { question: 'Quel est le prix moyen au m² à Tavernes ?', answer: 'Le prix moyen d’une maison à Tavernes se situe généralement entre 2 400 et 3 000 €/m² selon l’état, le terrain et l’emplacement. Les maisons avec terrain et vue dégagée se négocient dans la fourchette haute.' },
      { question: 'Comment réussir l’estimation de sa maison à Tavernes ?', answer: 'Il convient d’analyser les ventes réelles enregistrées aux impôts (DVF) sur la commune et de pondérer selon l’état du bien, le terrain, le DPE et la concurrence disponible sur le secteur Barjols-Tavernes.' },
      { question: 'Combien de temps faut-il pour vendre à Tavernes ?', answer: 'Un bien correctement positionné au prix de marché trouve généralement preneur entre 30 et 60 jours. Une surestimation initiale allonge significativement le délai de vente.' },
    ],
  },
}
